function out=F2014_dynamics_COP1(t,y,param,sunrise,sunset)
...
% COP1c
out(24) = n5 - p6 * COP1c - m27 * COP1c * (1 + p15 * RedL);

% COP1n
out(25) = p6 * COP1c - (n14 + n6 * RedL * P) * COP1n - m27 * COP1n * (1 + p15 * RedL);

% COP1d
out(26) = (n14 + n6 * RedL * P) * COP1n - m31 * (1 + m33 * RedD) * COP1d;
