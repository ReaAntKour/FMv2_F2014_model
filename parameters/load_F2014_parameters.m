...
if (nargin==1)||(set==1)
	...
	ParamTable=readtable('F2014_Parameter_table.txt','ReadRowNames',true);
	param=ParamTable.(['set',int2str(set)]);
	param = num2cell(param);
	[a3,a4,a5,a6,a7,a8,r1,r2,r3,r4,r5,r6,r7,r8,r9,r10,r11,r12,r13,r14,r15,...
		r16,r17,r18,r19,r20,r21,r22,r23,r24,r25,r26,r27,r28,r29,r30,r31,...
		r32,r33,r34,r35,r36,r37,r38,r40,~,f1,f2,f3,f4,f5,f6,t5,t6,t7,t8,...
		...
		m45,m46,m47,p11,p16,p23,p25,p28,p29,q1,q3] = deal(param{:});
end
